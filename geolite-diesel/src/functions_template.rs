//! Template source for generated Diesel SQL declarations.
//!
//! Edit this file, then regenerate `src/generated/functions.rs` via:
//! `cargo run -p xtask -- gen-function-surfaces`.
//!
