...
diesel::table! { grid (id) { id -> Integer, name -> Text, geom -> Nullable<geolite::diesel::Geometry>, } }
diesel::table! { iw_grid (id) { id -> Integer, geom -> Nullable<geolite::diesel::Geometry>, } }
diesel::table! { ip_pts (id) { id -> Integer, name -> Text, geom -> Nullable<geolite::diesel::Geometry>, } }
diesel::table! { ic_polys (id) { id -> Integer, name -> Text, geom -> Nullable<geolite::diesel::Geometry>, } }
diesel::table! { igr_cities (id) { id -> Integer, name -> Text, geom -> Nullable<geolite::diesel::Geometry>, } }
diesel::table! { knn_grid (id) { id -> Integer, geom -> Nullable<geolite::diesel::Geometry>, } }
diesel::table! { knn_cities (id) { id -> Integer, name -> Text, geom -> Nullable<geolite::diesel::Geometry>, } }
diesel::table! { sw_grid (id) { id -> Integer, geom -> Nullable<geolite::diesel::Geometry>, } }
diesel::table! { sk_grid (id) { id -> Integer, geom -> Nullable<geolite::diesel::Geometry>, } }
...
fn orm_geometry_roundtrip() {
    use geolite::diesel::types::Geometry as GeomType;
...
fn st_makepoint_typed_diesel_function() {
    use geolite::diesel::functions::st_makepoint;
    let mut c = conn();
    let wkt: Option<String> = diesel::dsl::select(
        geolite::diesel::functions::st_astext(st_makepoint(1.5_f64, 2.5_f64).nullable()),
    )
    .get_result(&mut c)
    .unwrap();
    let wkt = wkt.unwrap();
...
fn geometry_type_typed_diesel_function() {
    use geolite::diesel::functions::{geometry_type, st_geomfromtext};
    let mut c = conn();
...
fn st_numinteriorring_typed_diesel_function() {
    use geolite::diesel::functions::{st_geomfromtext, st_numinteriorring};
    let mut c = conn();
...
fn st_length2d_typed_diesel_function() {
    use geolite::diesel::functions::{st_geomfromtext, st_length2d};
    let mut c = conn();
    let len: Option<f64> =
...
fn st_perimeter2d_typed_diesel_function() {
    use geolite::diesel::functions::{st_geomfromtext, st_perimeter2d};
    let mut c = conn();
