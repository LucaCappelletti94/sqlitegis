...
///
/// ```
/// use geolite::core::functions::measurement::st_length;
/// use geolite::core::functions::io::geom_from_text;
///
...
///
/// ```
/// use geolite::core::functions::measurement::st_perimeter;
/// use geolite::core::functions::io::geom_from_text;
///
/// let poly = geom_from_text("POLYGON((0 0,1 0,1 1,0 1,0 0))", None).unwrap();
...
///
/// ```
/// use geolite::core::functions::measurement::st_centroid;
/// use geolite::core::functions::accessors::{st_x, st_y};
/// use geolite::core::functions::io::geom_from_text;
///
...
///
/// ```
/// use geolite::core::functions::measurement::st_point_on_surface;
/// use geolite::core::functions::predicates::st_within;
/// use geolite::core::functions::io::geom_from_text;
///
...
///
/// ```
/// use geolite::core::functions::measurement::st_hausdorff_distance;
/// use geolite::core::functions::io::geom_from_text;
///
...
///
/// ```
/// use geolite::core::functions::measurement::st_xmin;
/// use geolite::core::functions::io::geom_from_text;
///
...
///
/// ```
/// use geolite::core::functions::measurement::st_xmax;
/// use geolite::core::functions::io::geom_from_text;
///
/// let blob = geom_from_text("LINESTRING(1 2,3 4)", None).unwrap();
...
///
/// ```
/// use geolite::core::functions::measurement::st_ymin;
/// use geolite::core::functions::io::geom_from_text;
///
/// let blob = geom_from_text("LINESTRING(1 2,3 4)", None).unwrap();
...
///
/// ```
/// use geolite::core::functions::measurement::st_ymax;
/// use geolite::core::functions::io::geom_from_text;
///
/// let blob = geom_from_text("LINESTRING(1 2,3 4)", None).unwrap();
...
///
/// ```
/// use geolite::core::functions::measurement::st_distance_sphere;
/// use geolite::core::functions::constructors::st_point;
///
...
///
/// ```
/// use geolite::core::functions::measurement::st_distance_spheroid;
/// use geolite::core::functions::constructors::st_point;
///
/// let london = st_point(-0.1278, 51.5074, Some(4326)).unwrap();
/// let paris = st_point(2.3522, 48.8566, Some(4326)).unwrap();
...
///
/// ```
/// use geolite::core::functions::measurement::st_length_sphere;
/// use geolite::core::functions::io::geom_from_text;
///
...
///
/// ```
/// use geolite::core::functions::measurement::st_azimuth;
/// use geolite::core::functions::constructors::st_point;
///
...
///
/// ```
/// use geolite::core::functions::measurement::st_project;
/// use geolite::core::functions::constructors::st_point;
...
///
/// ```
/// use geolite::core::functions::measurement::st_closest_point;
/// use geolite::core::functions::constructors::st_point;
/// use geolite::core::functions::accessors::{st_x, st_y};
/// use geolite::core::functions::io::geom_from_text;
///
