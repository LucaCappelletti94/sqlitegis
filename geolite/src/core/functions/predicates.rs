...
///
/// ```
/// use geolite::core::functions::predicates::st_intersects;
...
///
/// ```
/// use geolite::core::functions::predicates::st_contains;
/// use geolite::core::functions::io::geom_from_text;
///
...
///
/// ```
/// use geolite::core::functions::predicates::st_disjoint;
/// use geolite::core::functions::io::geom_from_text;
///
...
///
/// ```
/// use geolite::core::functions::predicates::st_dwithin;
...
///
/// ```
/// use geolite::core::functions::predicates::st_dwithin_sphere;
/// use geolite::core::functions::constructors::st_point;
///
...
///
/// ```
/// use geolite::core::functions::predicates::st_dwithin_spheroid;
/// use geolite::core::functions::constructors::st_point;
///
/// let a = st_point(-0.1278, 51.5074, Some(4326)).unwrap(); // London
/// let b = st_point(2.3522, 48.8566, Some(4326)).unwrap(); // Paris
...
///
/// ```
/// use geolite::core::functions::predicates::st_covers;
/// use geolite::core::functions::io::geom_from_text;
///
/// let poly = geom_from_text("POLYGON((0 0,4 0,4 4,0 4,0 0))", None).unwrap();
/// let pt = geom_from_text("POINT(2 2)", None).unwrap();
...
///
/// ```
/// use geolite::core::functions::predicates::st_covered_by;
/// use geolite::core::functions::io::geom_from_text;
///
/// let pt = geom_from_text("POINT(2 2)", None).unwrap();
/// let poly = geom_from_text("POLYGON((0 0,4 0,4 4,0 4,0 0))", None).unwrap();
...
///
/// ```
/// use geolite::core::functions::predicates::st_equals;
/// use geolite::core::functions::io::geom_from_text;
///
...
///
/// ```
/// use geolite::core::functions::predicates::st_touches;
/// use geolite::core::functions::io::geom_from_text;
///
...
///
/// ```
/// use geolite::core::functions::predicates::st_crosses;
/// use geolite::core::functions::io::geom_from_text;
///
...
///
/// ```
/// use geolite::core::functions::predicates::st_overlaps;
/// use geolite::core::functions::io::geom_from_text;
///
/// let a = geom_from_text("POLYGON((0 0,2 0,2 2,0 2,0 0))", None).unwrap();
...
///
/// ```
/// use geolite::core::functions::predicates::st_relate;
/// use geolite::core::functions::io::geom_from_text;
///
/// let a = geom_from_text("POINT(0 0)", None).unwrap();
...
///
/// ```
/// use geolite::core::functions::predicates::st_relate_match_geoms;
/// use geolite::core::functions::io::geom_from_text;
///
/// let a = geom_from_text("POLYGON((0 0,2 0,2 2,0 2,0 0))", None).unwrap();
/// let b = geom_from_text("POINT(1 1)", None).unwrap();
...
///
/// ```
/// use geolite::core::functions::predicates::st_relate_match;
///
