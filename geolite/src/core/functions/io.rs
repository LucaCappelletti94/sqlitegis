...
///
/// ```
/// use geolite::core::functions::io::{geom_from_text, as_binary, geom_from_wkb};
/// use geolite::core::ewkb::extract_srid;
///
...
///
/// ```
/// use geolite::core::functions::io::{geom_from_text, geom_from_ewkb};
///
/// let blob = geom_from_text("POINT(1 2)", Some(4326)).unwrap();
...
///
/// ```
/// use geolite::core::functions::io::geom_from_geojson;
/// use geolite::core::ewkb::extract_srid;
///
...
///
/// ```
/// use geolite::core::functions::io::{geom_from_text, as_text};
///
/// let blob = geom_from_text("POINT(1 2)", None).unwrap();
...
///
/// ```
/// use geolite::core::functions::io::{geom_from_text, as_ewkt};
///
/// let blob = geom_from_text("POINT(1 2)", Some(4326)).unwrap();
...
///
/// ```
/// use geolite::core::functions::io::{geom_from_text, as_binary};
/// use geolite::core::ewkb::extract_srid;
///
/// let blob = geom_from_text("POINT(1 2)", Some(4326)).unwrap();
/// let wkb = as_binary(&blob).unwrap();
...
///
/// ```
/// use geolite::core::functions::io::{geom_from_text, as_ewkb};
///
/// let blob = geom_from_text("POINT(1 2)", Some(4326)).unwrap();
...
///
/// ```
/// use geolite::core::functions::io::{geom_from_text, as_geojson};
///
/// let blob = geom_from_text("POINT(1 2)", None).unwrap();
