...
/// use geolite::core::functions::accessors::{st_x, st_y, st_srid};
///
...
///
/// ```
/// use geolite::core::functions::constructors::{st_point, st_make_line};
...
///
/// ```
/// use geolite::core::functions::constructors::st_make_polygon;
...
///
/// ```
/// use geolite::core::functions::constructors::st_make_envelope;
...
///
/// ```
/// use geolite::core::functions::constructors::{st_point, st_collect};
/// use geolite::core::functions::accessors::{st_num_geometries, st_geometry_type};
///
/// let a = st_point(0.0, 0.0, None).unwrap();
/// let b = st_point(1.0, 1.0, None).unwrap();
...
///
/// ```
/// use geolite::core::functions::constructors::st_tile_envelope;
