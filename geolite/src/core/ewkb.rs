...
///
/// ```
/// use geolite::core::ewkb::parse_ewkb_header;
...
///
/// ```
/// use geolite::core::ewkb::parse_ewkb;
/// use geolite::core::functions::io::geom_from_text;
///
/// let blob = geom_from_text("POINT(1 2)", Some(4326)).unwrap();
...
/// ```
/// use geo::{Geometry, Point};
/// use geolite::core::ewkb::{write_ewkb, parse_ewkb};
///
...
///
/// ```
/// use geolite::core::ewkb::{set_srid, extract_srid};
/// use geolite::core::functions::io::geom_from_text;
///
/// let blob = geom_from_text("POINT(1 2)", Some(4326)).unwrap();
...
///
/// ```
/// use geolite::core::ewkb::{geom_type_name, WKB_POINT, WKB_POLYGON};
///
