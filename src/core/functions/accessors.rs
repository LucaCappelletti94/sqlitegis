...
///
/// ```
/// use sqlitegis::core::functions::accessors::{st_srid, st_set_srid};
/// use sqlitegis::core::functions::io::geom_from_text;
///
/// let blob = geom_from_text("POINT(1 2)", Some(4326)).unwrap();
...
///
/// ```
/// use sqlitegis::core::functions::accessors::st_ndims;
/// use sqlitegis::core::functions::io::geom_from_text;
///
/// let blob = geom_from_text("POINT(1 2)", None).unwrap();
...
///
/// ```
/// use sqlitegis::core::functions::accessors::st_coord_dim;
/// use sqlitegis::core::functions::io::geom_from_text;
///
/// let blob = geom_from_text("POINT(1 2)", None).unwrap();
...
///
/// ```
/// use sqlitegis::core::functions::accessors::st_zmflag;
/// use sqlitegis::core::functions::io::geom_from_text;
///
/// let blob = geom_from_text("POINT(1 2)", None).unwrap();
...
///
/// ```
/// use sqlitegis::core::functions::accessors::st_is_empty;
/// use sqlitegis::core::functions::io::geom_from_text;
///
/// let blob = geom_from_text("POINT(1 2)", None).unwrap();
...
///
/// ```
/// use sqlitegis::core::functions::accessors::st_mem_size;
/// use sqlitegis::core::functions::io::geom_from_text;
///
/// let blob = geom_from_text("POINT(1 2)", None).unwrap();
...
///
/// ```
/// use sqlitegis::core::functions::accessors::st_x;
/// use sqlitegis::core::functions::io::geom_from_text;
///
...
///
/// ```
/// use sqlitegis::core::functions::accessors::st_z;
/// use sqlitegis::core::functions::io::geom_from_text;
///
/// let blob = geom_from_text("POINT(3.5 7.2)", None).unwrap();
...
///
/// ```
/// use sqlitegis::core::functions::accessors::st_npoints;
/// use sqlitegis::core::functions::io::geom_from_text;
///
...
///
/// ```
/// use sqlitegis::core::functions::accessors::st_num_geometries;
/// use sqlitegis::core::functions::io::geom_from_text;
///
...
///
/// ```
/// use sqlitegis::core::functions::accessors::st_num_interior_rings;
/// use sqlitegis::core::functions::io::geom_from_text;
///
...
///
/// ```
/// use sqlitegis::core::functions::accessors::st_num_rings;
/// use sqlitegis::core::functions::io::geom_from_text;
///
/// let blob = geom_from_text("POLYGON((0 0,10 0,10 10,0 10,0 0),(1 1,2 1,2 2,1 2,1 1))", None).unwrap();
...
///
/// ```
/// use sqlitegis::core::functions::accessors::{st_point_n, st_x, st_y};
/// use sqlitegis::core::functions::io::geom_from_text;
///
/// let blob = geom_from_text("LINESTRING(0 0,1 1,2 2)", None).unwrap();
...
///
/// ```
/// use sqlitegis::core::functions::accessors::{st_start_point, st_x};
/// use sqlitegis::core::functions::io::geom_from_text;
///
...
///
/// ```
/// use sqlitegis::core::functions::accessors::{st_end_point, st_x};
/// use sqlitegis::core::functions::io::geom_from_text;
///
/// let blob = geom_from_text("LINESTRING(10 20,30 40)", None).unwrap();
...
///
/// ```
/// use sqlitegis::core::functions::accessors::{st_exterior_ring, st_num_points};
/// use sqlitegis::core::functions::io::geom_from_text;
///
/// let blob = geom_from_text("POLYGON((0 0,1 0,1 1,0 1,0 0))", None).unwrap();
...
///
/// ```
/// use sqlitegis::core::functions::accessors::st_interior_ring_n;
/// use sqlitegis::core::functions::io::geom_from_text;
///
...
///
/// ```
/// use sqlitegis::core::functions::accessors::{st_geometry_n, st_geometry_type};
/// use sqlitegis::core::functions::io::geom_from_text;
///
/// let blob = geom_from_text("MULTIPOINT((0 0),(1 1))", None).unwrap();
...
///
/// ```
/// use sqlitegis::core::functions::accessors::st_dimension;
/// use sqlitegis::core::functions::io::geom_from_text;
///
...
///
/// ```
/// use sqlitegis::core::functions::accessors::st_envelope;
/// use sqlitegis::core::functions::io::geom_from_text;
///
...
///
/// ```
/// use sqlitegis::core::functions::accessors::st_is_valid;
/// use sqlitegis::core::functions::io::geom_from_text;
///
/// let blob = geom_from_text("POLYGON((0 0,1 0,1 1,0 1,0 0))", None).unwrap();
...
///
/// ```
/// use sqlitegis::core::functions::accessors::st_is_valid_reason;
/// use sqlitegis::core::functions::io::geom_from_text;
///
/// let blob = geom_from_text("POLYGON((0 0,1 0,1 1,0 1,0 0))", None).unwrap();
